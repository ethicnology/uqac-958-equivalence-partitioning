 ...
 * ================================================================================== 
 * 
 * We are using heuristics Range and Specific
 * 			
 * 
 * =======================      	    ITEM LIST  		      ======================= 
 ...
 * 
 * =======================          	Unit Price                 ==================== 
 * v.7 : Price between [0, 35] (Range)		|	i.15: Price > 35 (Range)
 * 											|	i.16: Price < 0 (Range)
 * 
 * =======================            Price Reduction              ==================== 
...
class RegisterTest {
    ...
    public void casualScenario() {
        ...
        // we did not found better ways to test that
    ...
    public void priceTooHighScenario() {   
    	...
    	float randomPrice = (float) (Math.random() * (maxInt-Register.MAX_AMOUNT+1) + Register.MAX_AMOUNT); 
    ...
    public void priceTooLowScenario() {   
    	...
    	float randomPrice = (float) (Math.random() * (0-lowestInt+1) + lowestInt); 
